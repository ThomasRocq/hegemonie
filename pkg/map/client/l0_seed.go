...
// Transform to a Raw MapMem. Raw maps are very similar to MapMem Seeds, they mostly differ
// by the kind/type of index used for the Sites (vertices): MapMem Seeds use strings, Raw Maps
// use sequential indexes.
func (ms *MapSeed) Transform() (MapRaw, error) {
	var err error
